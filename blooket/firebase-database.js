import {_getProvider, getApp as e, _registerComponent as t, registerVersion as n, SDK_VERSION as r} from "https://www.gstatic.com/firebasejs/10.10.0/firebase-app.js";
const i = !1
  , o = "${JSCORE_VERSION}"
  , assert = function(e, t) {
    if (!e)
