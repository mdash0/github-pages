import {_getProvider, _isFirebaseServerApp as e, _registerComponent as t, registerVersion as r, getApp as n, SDK_VERSION as i} from "https://www.gstatic.com/firebasejs/10.10.0/firebase-app.js";
const s = {
    byteToCharMap_: null,
    charToByteMap_: null,
...
function _serverAppCurrentUserOperationNotSupportedError(e) {
    return _errorWithCustomMessage(e, "operation-not-supported-in-this-environment", "Operations that alter the current user are not supported in conjunction with FirebaseServerApp")
}
...
class NetworkTimeout {
    constructor(e) {
        ...
        this.promise = new Promise(( (e, t) => {
            this.timer = setTimeout(( () => t(_createError(this.auth, "network-request-failed"))), A.get())
        }
        ))
    }
    clearNetworkTimeout() {
...
async function _reloadWithoutSaving(e) {
    ...
    const r = e.auth
      ...
      , i = await _logoutIfInvalidated(e, getAccountInfo(r, {
        idToken: n
    }));
    _assert(null == i ? void 0 : i.users.length, r, "internal-error");
    const s = i.users[0];
    e._notifyReloadListener(s);
    const o = (null === (t = s.providerUserInfo) || void 0 === t ? void 0 : t.length) ? extractProviderData(s.providerUserInfo) : []
...
class StsTokenManager {
    ...
    updateFromServerResponse(e) {
        ...
        const t = "expiresIn"in e && void 0 !== e.expiresIn ? Number(e.expiresIn) : _tokenExpiresIn(e.idToken);
    ...
    async getToken(e, t=!1) {
        return t || !this.accessToken || this.isExpired ? (_assert(this.refreshToken, e, "user-token-expired"),
...
class UserImpl {
    ...
    static _fromJSON(e, t) {
        ...
        const d = null !== (r = t.displayName) && void 0 !== r ? r : void 0
          ...
          , {uid: I, emailVerified: v, isAnonymous: E, providerData: T, stsTokenManager: A} = t;
        ...
        return T && Array.isArray(T) && (w.providerData = T.map((e => Object.assign({}, e)))),
    ...
    static async _fromGetAccountInfoResponse(e, t, r) {
        ...
        const i = void 0 !== n.providerUserInfo ? extractProviderData(n.providerUserInfo) : []
        ...
        const a = new UserImpl({
          ...
          , c = {
            ...
            isAnonymous: !(n.email && n.passwordHash || (null == i ? void 0 : i.length))
        };
...
class PersistenceUserManager {
    ...
    static async create(e, t, r="authUser") {
        if (!t.length)
            return new PersistenceUserManager(_getInstance(w),e,r);
...
class AuthImpl {
    ...
    async initializeCurrentUser(t) {
        ...
        if (t && this.config.authDomain) {
            ...
            const e = null === (r = this.redirectUser) || void 0 === r ? void 0 : r._redirectEventId
              , n = null == i ? void 0 : i._redirectEventId
              , o = await this.tryRedirectSignIn(t);
            e && e !== n || !(null == o ? void 0 : o.user) || (i = o.user,
            s = !0)
        }
        if (!i)
    ...
    async updateCurrentUser(t) {
        ...
        return r && _assert(r.auth.config.apiKey === this.config.apiKey, this, "invalid-user-token"),
    ...
    async signOut() {
        return e(this.app) ? Promise.reject(_serverAppCurrentUserOperationNotSupportedError(this)) : (await this.beforeStateQueue.runMiddleware(null),
        (this.redirectPersistenceManager || this._popupRedirectResolver) && await this._setRedirectUser(null),
        this._updateCurrentUser(null, !0))
    }
    setPersistence(t) {
        return e(this.app) ? Promise.reject(_serverAppCurrentUserOperationNotSupportedError(this)) : this.queue((async () => {
...
async function signInAnonymously(t) {
    ...
    const n = _castAuth(t);
    if (await n._initializationPromise,
    ...
    return await n._updateCurrentUser(s.user),
    s
}
...
async function _reauthenticate(t, r, n=!1) {
    ...
    try {
        const e = await _logoutIfInvalidated(t, _processCredentialSavingMfaContextIfNecessary(i, s, r, t), n);
        _assert(e.idToken, i, "internal-error");
        const o = _parseToken(e.idToken);
        _assert(o, i, "internal-error");
        const {sub: a} = o;
        return _assert(t.uid === a, i, "user-mismatch"),
        UserCredentialImpl._forOperation(t, s, e)
    } catch (e) {
        throw "auth/user-not-found" === (null == e ? void 0 : e.code) && _fail(i, "user-mismatch"),
        e
    }
}
async function _signInWithCredential(t, r, n=!1) {
    ...
    return n || await t._updateCurrentUser(o.user),
    o
}
...
async function createUserWithEmailAndPassword(t, r, n) {
    ...
    const i = _castAuth(t)
      ...
      , o = await s.catch((e => {
        throw "auth/password-does-not-meet-requirements" === e.code && recachePasswordPolicy(t),
        e
    }
    ))
...
function signInWithEmailAndPassword(t, r, n) {
    return e(t.app) ? Promise.reject(_serverAppCurrentUserOperationNotSupportedError(t)) : signInWithCredential(getModularInstance(t), EmailAuthProvider.credential(r, n)).catch((async e => {
        throw "auth/password-does-not-meet-requirements" === e.code && recachePasswordPolicy(t),
        e
    }
    ))
...
async function signInWithEmailLink(t, r, n) {
    ...
    return _assert(s._tenantId === (i.tenantId || null), i, "tenant-id-mismatch"),
...
function updateEmail(t, r) {
    ...
    return e(n.auth.app) ? Promise.reject(_serverAppCurrentUserOperationNotSupportedError(n.auth)) : updateEmailOrPassword(n, r, null)
}
...
function multiFactor(e) {
    const t = getModularInstance(e);
    return R.has(t) || R.set(t, MultiFactorUserImpl._fromUser(t)),
    R.get(t)
}
...
class ReCaptchaLoaderImpl {
    ...
    load(e, t="") {
        ...
        this.shouldResolveImmediately(t) && isV2(_window().grecaptcha) ? Promise.resolve(_window().grecaptcha) : new Promise(( (r, n) => {
            ...
            ;
            _loadJS(`${function _recaptchaV2ScriptUrl() {
...
async function reauthenticateWithPhoneNumber(t, r, n) {
    const i = getModularInstance(t);
    if (e(i.auth.app))
        return Promise.reject(_serverAppCurrentUserOperationNotSupportedError(i.auth));
    const s = await _verifyPhoneNumber(i.auth, r, getModularInstance(n));
    return new ConfirmationResultImpl(s,(e => reauthenticateWithCredential(i, e)))
}
...
async function updatePhoneNumber(t, r) {
    const n = getModularInstance(t);
    if (e(n.auth.app))
        return Promise.reject(_serverAppCurrentUserOperationNotSupportedError(n.auth));
    await _link$1(n, r)
}
...
async function signInWithPopup(t, r, n) {
    if (e(t.app))
        return Promise.reject(_createError(t, "operation-not-supported-in-this-environment"));
    const i = _castAuth(t);
...
async function reauthenticateWithPopup(t, r, n) {
    const i = getModularInstance(t);
    if (e(i.auth.app))
        return Promise.reject(_createError(i.auth, "operation-not-supported-in-this-environment"));
...
class RedirectAction extends AbstractPopupRedirectOperation {
    ...
    async execute() {
        ...
        return this.bypassAuthState || U.set(this.auth._key(), ( () => Promise.resolve(null))),
        e()
    }
    async onAuthEvent(e) {
...
function signInWithRedirect(t, r, n) {
    return async function _signInWithRedirect(t, r, n) {
        ...
        const s = _withDefaultResolver(i, n);
        return await _setPendingRedirectStatus(s, i),
...
function reauthenticateWithRedirect(t, r, n) {
    return async function _reauthenticateWithRedirect(t, r, n) {
        const i = getModularInstance(t);
        if (_assertInstanceOf(i.auth, r, FederatedAuthProvider),
        e(i.auth.app))
            return Promise.reject(_serverAppCurrentUserOperationNotSupportedError(i.auth));
    ...
    return new Promise(( (t, r) => {
        ...
        if (null === (i = null === (n = _window().gapi) || void 0 === n ? void 0 : n.iframes) || void 0 === i ? void 0 : i.Iframe)
            ...
            if (!(null === (s = _window().gapi) || void 0 === s ? void 0 : s.load)) {
                ...
                ,
                _loadJS(`${function _gapiScriptUrl() {
                    return S.gapiScript
                }()}?onload=${t}`).catch((e => r(e)))
            }
            loadGapiIframe()
        }
    }
...
const H = new Delay(5e3,15e3)
  ...
  , q = new Map([["identitytoolkit.googleapis.com", "p"], ["staging-identitytoolkit.sandbox.googleapis.com", "s"], ["test-identitytoolkit.sandbox.googleapis.com", "t"]]);
function getIframeUrl(e) {
    ...
    return o.length && (n.fw = o.join(",")),
    `${r}?${querystring(n).slice(1)}`
}
async function _openIframe(e) {
    const t = await function _loadGapi(e) {
        return W = W || loadGapi(e),
        W
    }(e)
      , r = _window().gapi;
...
function _open(e, t, r, n=500, i=600) {
    ...
    _isFirefox(u) && (t = t || "http://localhost",
    c.scrollbars = "yes");
...
function getAuth(e=n()) {
    ...
    var s;
    const o = (a = "auth",
    null === (u = null === (c = getDefaults()) || void 0 === c ? void 0 : c.emulatorHosts) || void 0 === u ? void 0 : u[a]);
    var a, c, u;
    return o && connectAuthEmulator(r, `http://${o}`),
    r
}
...
function registerAuth(e) {
    t(new Component("auth",( (t, {options: r}) => {
    ...
    t(new Component("auth-internal",(e => (e => new AuthInterop(e))(_castAuth(e.getProvider("auth").getImmediate()))),"PRIVATE").setInstantiationMode("EXPLICIT")),
    r(K, "1.7.0", function getVersionForPlatform(e) {
        switch (e) {
        case "Node":
            return "node";
        case "ReactNative":
